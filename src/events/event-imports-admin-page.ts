...
<body><main class="shell">
  ...
  <section id="dashboard" class="hidden"><div class="toolbar"><button id="refresh">새로고침</button><span id="summary"></span></div><div class="layout">
    ...
    <aside class="card detail"><div id="detail-empty" class="empty">실행을 선택하세요.</div><div id="detail" class="hidden"><div class="detail-head"><div><span id="detail-status" class="badge"></span><h2 id="detail-run"></h2></div></div><dl id="metadata"></dl><h3>배치 메타데이터</h3><div id="parts"></div></div></aside>
  </div></section>
